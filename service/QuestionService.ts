...
//获取问题列表
  getQuestionList(){
        ...
        },
        {
            ...
            questionType: 'singleChoice',
            selectAId: 'A',
            selectAContent: '$20^{\\circ}$',
            selectAStatus:'selectBefore',
            selectBId: 'B',
            selectBContent: '$30^{\\circ}$',
            selectBStatus:'selectBefore',
            selectCId: 'C',
            selectCContent: '$35^{\\circ}$',
            selectCStatus:'selectBefore',
            selectDId: 'D',
            selectDContent: '$40^{\\circ}$',
            selectDStatus:'selectBefore',
            showFlag: false,
            clickFlag:'',
            answer: 'D',
...

        {
            ...
            questionType: 'singleChoice',
            selectAId: 'A',
            selectAContent: '$BC=EC,{\\angle} B={\\angle} E$',
            selectAStatus:'selectBefore',
            selectBId: 'B',
            selectBContent: '$BC=EC,AC=DC$',
            selectBStatus:'selectBefore',
            selectCId: 'C',
            selectCContent: '$BC=EC,{\\angle}A={\\angle}D$',
            selectCStatus:'selectBefore',
            selectDId: 'D',
            selectDContent: '${\\angle}B={\\angle}E,{\\angle}A={\\angle}D$',
            selectDStatus:'selectBefore',
            showFlag: false,
            clickFlag:'',
            answer: 'B',
        ...
        },
        {
            ...
            questionField1:'',
            imgAnswer:'assets/img/test/chapter1/dzd_bsd_8x_p3-17_j.svg',
            filledBlank1:'1',
            fillBlankStatus:'fillBlankAnswerBefore',
            favorites:false,
            promptCount: 0
