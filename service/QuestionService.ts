...
//获取问题列表
  getQuestionList(){
        this.questionList = [
        {
            ...
            img:['assets/img/test/chapter1/53_bsd_8x_p2-5_t.svg','http://localhost:8100/youranxue/image/imageDisplay/books_cover_mathTest.svg'],
            questionType: 'singleChoice',
            answerList:[
                {id:'A',content:'0个',isRightAnswer:'false',explan:'这个答案是错的'},
                {id:'B',content:'1个',isRightAnswer:'false',explan:'这个也是错的'},
                {id:'C',content:'2个',isRightAnswer:'false',explan:'这个又错了'},
                {id:'D',content:'3个',isRightAnswer:'true',explan:'这个是对的'},
            ],
            favorites:true,
            promptCount: 0
        },
        {
            ...
            img:['assets/img/test/chapter1/53_bsd_8x_p1-1_t.svg'],
            questionType: 'singleChoice',
            answerList:[
                {id:'A',content:'$20^{\\circ}$',isRightAnswer:'false',explan:'这个答案是错的'},
                {id:'B',content:'$30^{\\circ}$',isRightAnswer:'false',explan:'这个答案是错的'},
                {id:'C',content:'$35^{\\circ}$',isRightAnswer:'true',explan:'这个是对的'},
                {id:'D',content:'$40^{\\circ}$',isRightAnswer:'false',explan:'这个答案是错的'},
            ],
            favorites:true,
            promptCount: 0
        },
         {
            ...
            img:['assets/img/test/chapter1/dzd_bsd_8x_p1-2_t.svg'],
            questionType: 'singleChoice',
            answerList:[
                {id:'A',content:'$BC=EC,{\\angle} B={\\angle} E$',isRightAnswer:'false',explan:'这个答案是错的'},
                {id:'B',content:'$BC=EC,AC=DC$',isRightAnswer:'false',explan:'这个答案是错的'},
                {id:'C',content:'$BC=EC,{\\angle}A={\\angle}D$',isRightAnswer:'false',explan:'这个答案是错的'},
                {id:'D',content:'${\\angle}B={\\angle}E,{\\angle}A={\\angle}D$',isRightAnswer:'true',explan:'这个是对的'},
            ],
            favorites:true,
            promptCount: 0
        },
